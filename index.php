...
<div class="mt-3 container">  
     ...
     <?php 
      ...
      <style type="text/css">
            @media only screen and (max-width: 767px){
                .div_show{
                    background: url('include/img/music_background/<?=$row1['image_name']?>');
    ...
    <div class="alert alert-dismissible fade show border m-0 p-0 shadow latest_add p-3 div_show" role="alert">
        <div class="row p-0 m-0">
            <div class=" order-1 order-md-2 p-0 m-0 position-relative overflow-hidden ">
            ...
            <div class="col-md-6 order-2 order-md-1 m-0 p-3 latest_add_res">
                <span>
                     <p class="badge badge-pill " style="font-size: 15px; background: #05445E;">Latest add</p> 
                    <h4 class="m-0" style="font-family: 'Fredoka One', cursive;color:#189AB4;">
                        <?=$row1['music_name']?>
                       
                    </h4><hr>
                    <p class="mt-2 p-2">
                       <?php 
                            echo substr($row1['info'],0,500);
                            echo strlen($row1['info'])>500?' .... ':'';
                        ?>
                    </p>

                    <a href="music_info.php?music_info=<?=$row1['music_id']?>">
                        <button class="btn btn-sm btn_detail" style="background:#05445E;color:white;">More Detail <i class="fas fa-arrow-right pr-2"></i></button>
                    </a>
    ...
    <div class="row" style="">
          <div class="row" style="margin: 20px 0;">
              <div class="col p-0"><h4 class="m-0">Songs ...</h4></div>
               <div class="col d-flex justify-content-end">
                   <a href="index.php"> <button class="btn btn-sm" title="page refresh" style="background: #05445E;color:white;"><i class="fa fa-refresh"></i></button></a>
                </div>
          </div>
          <hr>
        <?php
        ...
        <div class="col-md-6">
         <style type="text/css">
            ...
            <div class="alert border shadow text-dark">
                <h5>
...
<!-- Footer -->
<div class="p-3 text-light pt-4" style="background:#05445E;">
